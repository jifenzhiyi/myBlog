<template>
  <div class="abs THEME">
    <a
      class="s1"
      @click="tabnext"
      @mouseover="showTips('要不要换个背景看一看？<br>快捷键 1', 'none')">切换背景</a>
    <a
      class="s2"
      @click="changeClothes"
      @mouseover="showTips('要不要换件衣服看一看？<br>快捷键 2', 'none')">切换衣服</a>
    <a
      class="s3"
      @click="changeModel"
      @mouseover="showTips('要不要换个人物看一看？<br>快捷键 3', 'none')">切换人物</a>
    <a
      class="s4"
      v-if="tindex===1"
      @click="changeMode"
