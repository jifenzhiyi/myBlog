...
! function(t) {
    ...
    r.prototype.loadModelData = function(t, i) {
        ...
        e.loadLive2DModel(t,
        function(t) {
            if (r.live2DModel = t, r.live2DModel.saveParam(), 0 != Live2D.getError()) return void console.error("Error 111: Failed to loadModelData().");
...
function(t, i, e) {
    ...
    function u(t) {
        ...
        s = T(o.y - i.top);
        w.
    default.DEBUG_MOUSE_LOG && log("onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        k = e,
        V = r,
        N.setPoint(n, s)
    }
    function p(t) {
        ...
        s = T(o.y - i.top);
        w.
    default.DEBUG_MOUSE_LOG && log("onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        k = e,
        V = r,
        R.tapEvent(n, s)
    }
    ...
    function d() {
        w.
    default.DEBUG_LOG && log("Set Session Storage."),
    ...
    function g(t) {
        if ("mousewheel" == t.type);
            ...
            w.
        default.DEBUG_LOG && log("Mouse out Window."),
            c();
        ...
        function() {
            ...
            i.prototype._$P7 = function(t, i, e, r) {
                ...
                if (0 != e) if (1 == t.length) {
                    ...
                    o < 0 && (log("No _$wi _$q0/ _$U default[%s]", t[0]), o = 0, n = 1, s.loadParam(), s.setParamFloat(t[o], n), s.saveParam());
                    for (var u = 0; u < t.length; u++) {
                        var h = i[u];
            ...
            _._$KL = function(t, i) {
                for (var e = 0; e < i; e++) e % 16 == 0 && e > 0 ? log("\n") : e % 8 == 0 && e > 0 && log("  "),
                log("X ", 255 & t[e]);
                log("\n")
            },
            ...
            It._$ni = function(t, i, e, r, o, n, s, _, a) {
                ...
                isNaN(l) && (l = (t - e - $ * s) / o, isNaN(l) && (l = (i - r - $ * _) / n), isNaN(l) && (log("a is NaN @UtVector#_$ni() "), log("v1x : " + o), log("v1x != 0 ? " + (0 != o)))),
            ...
            F.prototype._$RT = function(t) {
                ...
                n = Math.sqrt(i * i + r * r),
                s = i * o - e * r;
                0 == n ? at._$so && log("affine._$RT() / rt==0") : (t[0] = n, t[1] = s / n, t[2] = (r * o + i * e) / s, t[3] = Math.atan2(r, i))
            },
                            ...
                            if (_ >= 0) {
                                ...
                                for (C._$D2.clear(), o = _ + 1; o < r && ("\r" != (n = 255 & t[o]) && "\n" != n); ++o) if ("," != n && " " != n && "\t" != n) {
                                    ...
                                    if (e[0] > 0) {
                                        ...
                                        var $ = e[0];
                                        if ($ < o) {
                                            log("_$n0 _$hi . @Live2DMotion loadMotion()\n");
                                            break
                                        }
                                        o = $
                                    }
            ...
            C.prototype.dump = function() {
                for (var t = 0; t < this.motions.length; t++) {
                    ...
                    log("_$wL[%s] [%d]. ", i._$4P, i._$I0.length);
                    for (var e = 0; e < i._$I0.length && e < 10; e++) log("%5.2f ,", i._$I0[e]);
                    log("\n")
                }
            },
            ...
            z.prototype._$Jr = function(t, i, e, r, o, n) {
                ...
                at._$so && log("_$L0 to transform _$SP\n")
            },
            H.prototype = new _t,
            W.prototype = new M,
            W._$ur = -2,
            ...
            at.setupProfile = function(t, i) {
                ...
                // arguments.length < 2 && (i = !0), i && log("profile : " + t.PROFILE_NAME);
                for (var e in t) at[e] = t[e],
                i && log("  [" + e + "] = " + t[e])
            },
            at.init = function() {
                if (at._$6b) {
                    // log("Live2D %s", at._$2s), at._$6b = !1;
                    ! 0,
                    at.initProfile()
                }
            },
            ...
            $t.prototype._$Nr = function(t, i) {
                var e = i;
                if (this != e._$GT() && log("### assert!! ### "), this._$GS._$Ur(t) && (W.prototype._$Nr.call(this, t, e), !e._$IS[0])) {
                    var r = $t._$gT;
                    r[0] = !1,
            ...
            $t.prototype.draw = function(t, i, e) {
                if (this != e._$GT() && log("### assert!! ### "), !e._$IS[0]) {
                    var r = e,
                    o = this._$LP;
                    o < 0 && (o = 1);
            ...
            $t.prototype.dump = function() {
                log("  _$yi( %d ) , _$d0( %d ) , _$Yo( %d ) \n", this._$LP, this._$d0, this._$Yo),
                log("  _$Oi _$di = { ");
                for (var t = 0; t < this._$BP.length; t++) log("] ,", this._$BP[t]);
                log("\n  _$5i _$30");
                for (var t = 0; t < this._$Eo.length; t++) {
                    log("\n    _$30[%d] = ", t);
                    for (var i = this._$Eo[t], e = 0; e < i.length; e++) log("%6.2f, ", i[e])
                }
                log("\n")
            },
...
default = o;
    ...
    o.prototype.maxScaleEvent = function() {
        $.
    default.DEBUG_LOG && log("Max scale event.");
    ...
    o.prototype.minScaleEvent = function() {
        $.
    default.DEBUG_LOG && log("Min scale event.");
        for (var t = 0; t < this.models.length; t++) this.models[t].startRandomMotion($.
    ...
    o.prototype.tapEvent = function(t, i) {
        $.
    default.DEBUG_LOG && log("tapEvent view x:" + t + " y:" + i);
        for (var e = 0; e < this.models.length; e++) this.models[e].hitTest($.
    default.HIT_AREA_HEAD, t, i) ? ($.
    default.DEBUG_LOG && log("Tap face."), this.models[e].setRandomExpression()) : this.models[e].hitTest($.
    default.HIT_AREA_BODY, t, i) ? ($.
    default.DEBUG_LOG && log("Tap body. models[" + e + "]"), this.models[e].startRandomMotion($.
    default.MOTION_GROUP_TAP_BODY, $.
    default.PRIORITY_NORMAL)):
        this.models[e].hitTestCustom("head", t, i) ? ($.
    default.DEBUG_LOG && log("Tap face."), this.models[e].startRandomMotion($.
    ...
    r.prototype.loadTexture = function(t, i, e, r) {
        ...
        n.onload = function() {
            ...
            try {
                ...
                s = null,
                "function" == typeof r && r();
                if (window.store.state.Index.modal_ready !== '') {
                    // console.log('live2d loadTexture', window.store.state.Index.modal_ready);
                    window.store.commit('SET_MODEL_TIPS', window.store.state.Index.modal_ready);
                }
            } catch(e) {
                log('画图失败', e, n.src);
            }
...
default = o;
    ...
    default.DEBUG_LOG && log("Motion is running."));
        var o, n = this;
    ...
    default.DEBUG_LOG && log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, i)) this.mainMotionManager.startMotionPrio(r, e);
        else {
            var n = this.modelSetting.getMotionSound(t, i),
            s = document.createElement("audio");
            s.src = this.modelHomeDir + n,
            h.
        default.DEBUG_LOG && log("Start sound : " + n),
            s.play(),
    ...
    o.prototype.setExpression = function(t) {
        ...
        h.
    default.DEBUG_LOG && log("Expression : " + t),
